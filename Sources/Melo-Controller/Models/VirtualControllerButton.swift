...
public extension VirtualControllerButton {
    ...
    static let back = Self("back", systemName: "plus.circle.fill", small: true)
    static let guide = Self("guide", systemName: "minus.circle.fill", small: true)
    static let start = Self("start", systemName: "gearshape.fill", small: true)
